...
public class CategoryDao {
    ...
    public void insertData(Category data) {
        String sql = "insert into category(category_id, department_id, name, description) values (:category_id, :department_id, :name, :description)";
        MapSqlParameterSource map = new MapSqlParameterSource();
        map.addValue("category_id", data.getCategory_id());
        map.addValue("department_id", data.getDepartment_id());
